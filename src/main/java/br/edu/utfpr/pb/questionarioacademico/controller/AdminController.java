...
//TODO: Lembrar de configurar Spring Security para estas e outras URLs 
public class AdminController extends br.edu.utfpr.pb.questionarioacademico.controller.commons.Controller{
	...
	public void insert(Professor professor) {
		...
		//verificando se já existe um administrador salvo
		boolean hasAdmin = usuarioRepository.hasAdmin();
		if(!hasAdmin){
			//setando o perfil professor em usuario
			professor.getPessoa().getUsuario().getPerfis().add(new Perfil("ADMINISTRADOR"));
